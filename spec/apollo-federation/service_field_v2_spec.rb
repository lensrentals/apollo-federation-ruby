...
RSpec.describe ApolloFederation::ServiceField do
  shared_examples 'service field' do
        ...
        context 'directives that apply to Apollo Federation 2.0+' do
          context 'given key' do
            context 'objects' do
              ...
              context 'muliple @key directives' do
                let(:query_obj) do
                  product = Class.new(base_object) do
                    graphql_name 'Product'
                    key fields: :upc
              ...
              context 'unresolvable @key directives' do
                let(:query_obj) do
                  product = Class.new(base_object) do
                    graphql_name 'Product'
              ...
              context 'resolvable @key directives' do
                let(:query_obj) do
                  product = Class.new(base_object) do
                    graphql_name 'Product'
          ...
          context 'given type extension' do
            context 'objects' do
              let(:query_obj) do
                product = Class.new(base_object) do
                  graphql_name 'Product'
            ...
            context 'fields' do
              let(:query_obj) do
                ...
                Class.new(base_object) do
                  ...
                  field :product, product, null: true, shareable: true
                end
              end
              ...
              it 'returns a valid SDL with @shareable directive' do
                expect(subject).to match_sdl(
                  <<~GRAPHQL,
                    ...
                    type Query {
                      product: Product @federation__shareable
                    }
                  GRAPHQL
                )
              end
        ...
        describe 'directives that apply to Apollo Federation 2.3' do
          context 'given tagged' do
            ...
            context 'fields' do
              ...
              context 'multiple @tag directives' do
                it 'returns a valid SDL' do
                  position = Class.new(base_object) do
                    graphql_name 'Position'
    ...
    it 'returns a SDL that honors visibility checks' do
      product = Class.new(base_object) do
        graphql_name 'Product'
        extend_type
        key fields: 'upc'
